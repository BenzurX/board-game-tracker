...
function mpRenderGroupSizeOptions() {
  ...
  // Nothing to choose when the room only has room for one more player.
  document.getElementById('group-size-row').classList.toggle('hidden', cap === 1);
...
function mpRenderGroupNameFields() {
  ...
  document.getElementById('group-size-hint').classList.toggle('hidden', mpGroupSize < 2);
}
